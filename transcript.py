...
START_READ = ("let's start reading", f"Let's start reading! {__explain_before_read}")
CONTINUE_READ = ("let's continue reading", f"Let's continue reading! {__explain_before_read}")
...
END_SESSION = ("That's all for today", "Alright! That's all for today!")
...
CONTINUE_READING = ("Want to continue reading?", "Do you want me to continue reading?")
INBETWEEN_QUESTION = ("Time for a question!", "Okay! Time for a question")
